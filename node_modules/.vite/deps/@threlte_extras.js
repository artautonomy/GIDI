...
import {
  ...
  watch
} from "./chunk-KNBVYOJO.js";
import "./chunk-SKZTLOIB.js";
import {
  fromStore
} from "./chunk-E7SEU2GV.js";
import {
  derived as derived2,
  get as get2,
  readable,
  writable
} from "./chunk-ZFR5GRX4.js";
import "./chunk-LLNQHWD7.js";
import {
  AdditiveBlending,
  AlwaysStencilFunc,
  AnimationMixer,
...
import {
  ...
  wrap_snippet
} from "./chunk-IBD55QT6.js";
import {
  append,
  comment,
  template
} from "./chunk-6VQS4TK6.js";
import {
  FILENAME,
  HMR,
  add_owner_effect,
...
function AnimatedSpriteMaterial($$anchor, $$props) {
  ...
  const textureStore = suspend(useTexture($$props.textureUrl, {
    transform: (value) => {
      ...
      value.magFilter = value.minFilter = strict_equals(filter(), "nearest") ? NearestFilter : LinearFilter;
      return value;
    }
  }));
    ...
    T(node, spread_props(
      ...
      () => props,
      {
        children: wrap_snippet(HTML, ($$anchor2, $$slotProps) => {
          ...
          var node_1 = first_child(fragment_1);
          if_block(node_1, () => occlude() && !get(isRayCastOcclusion), ($$anchor3) => {
            var fragment_2 = comment();
...
function Environment($$anchor, $$props) {
  ...
  var fragment = comment();
  var node = first_child(fragment);
  if_block(node, groundProjection, ($$anchor2) => {
    var fragment_1 = comment();
    var node_1 = first_child(fragment_1);
...
function Api($$anchor, $$props) {
  ...
  for (let i = 0; i < $$props.limit; (i += 1) - 1) tempMatrix.identity().toArray(matrices, i * 16);
  ...
  useTask(() => {
    ...
    if ($$props.update || !initialUpdateDone) {
      ...
      for (let i = 0, l = instances.current.length; i < l; (i += 1) - 1) {
...
function MeshLineGeometry($$anchor, $$props) {
  ...
  const setPoints = (points2) => {
    ...
    previous.setXYZ(previousIndex, p1.x, p1.y, p1.z);
    previousIndex += 1;
    for (let i = 0; i < pointCount; (i += 1) - 1) {
      const p = points2[i];
...
function CSM_1($$anchor, $$props) {
  ...
  var node_1 = sibling(node, 2);
  if_block(node_1, () => !enabled(), ($$anchor2) => {
    var fragment_1 = comment();
    var node_2 = first_child(fragment_1);
...
function Text3DGeometry($$anchor, $$props) {
  ...
  var fragment = comment();
  var node = first_child(fragment);
  if_block(node, () => get(creasedGeometry), ($$anchor2) => {
    var fragment_1 = comment();
    var node_1 = first_child(fragment_1);
    {
      add_owner_effect(ref, T);
