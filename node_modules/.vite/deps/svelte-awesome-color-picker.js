...
function ColorPicker($$anchor, $$props) {
  ...
  function updateColor() {
    ...
    if (strict_equals(hex()?.substring(7), "ff")) hex(hex().substring(0, 7));
    if (strict_equals(hex()?.substring(7), "ff")) hex(hex().substring(0, 7));
  ...
  component(node_3, () => getComponents().wrapper, ($$anchor2, $$component) => {
    ...
    $$component($$anchor2, {
      ...
      children: wrap_snippet(ColorPicker, ($$anchor3, $$slotProps) => {
        ...
        var h = derived_safe_equal(() => hsv()?.h ?? get(_hsv).h);
        var s = derived_safe_equal(() => hsv()?.s ?? get(_hsv).s);
        var v = derived_safe_equal(() => hsv()?.v ?? get(_hsv).v);
        ...
        var value = derived_safe_equal(() => hsv()?.h ?? get(_hsv).h);
        ...
        var node_8 = sibling(div, 2);
        {
          var consequent_3 = ($$anchor4) => {
            ...
            var value_1 = derived_safe_equal(() => hsv()?.a ?? get(_hsv).a);
