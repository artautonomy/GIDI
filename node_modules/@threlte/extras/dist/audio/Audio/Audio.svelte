...
let { src, id, volume, playbackRate, autoplay, detune, loop, ref = $bindable(), children, ...props } = $props();
...
const { setAutoPlay, setDetune, setLoop, setPlaybackRate, setSrc, setVolume, ...useAudioProps } = useAudio(audio, props);
