...
let { renderTask, animationTask, turnRate = 2 * Math.PI, center = [0, 0, 0], verticalPlacement = 'bottom', horizontalPlacement = 'right', size = 128, xColor = 0xff3653, yColor = 0x8adb00, zColor = 0x2c8fff, toneMapped = false, paddingX = 0, paddingY = 0 } = $props();
...
let posX = $state(undefined);
let posY = $state(undefined);
let posZ = $state(undefined);
let negX = $state(undefined);
let negY = $state(undefined);
let negZ = $state(undefined);
