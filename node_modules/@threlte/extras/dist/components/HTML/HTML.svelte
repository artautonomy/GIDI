...
let { eps = 0.001, center = false, fullscreen = false, portal, distanceFactor, sprite = false, transform = false, occlude = false, castShadow, receiveShadow, material, geometry, zIndexRange = [16777271, 0], calculatePosition = defaultCalculatePosition, as = 'div', wrapperClass, pointerEvents = 'auto', ref = $bindable(), visible = $bindable(), style, children, ...props } = $props();
visible = true;
