...
let { cellColor = '#000000', sectionColor = '#0000ee', cellSize = 1, backgroundColor = '#dadada', backgroundOpacity = 0, sectionSize = 10, plane = 'xz', gridSize = [20, 20], followCamera = false, infiniteGrid = false, fadeDistance = 100, fadeStrength = 1, cellThickness = 1, sectionThickness = 2, side = DoubleSide, type = 'grid', axis = 'x', maxRadius = 0, cellDividers = 6, sectionDividers = 2, ref = $bindable(), children, ...props } = $props();
const mesh = new Mesh();
